...
**By scope, narrowest to broadest:** one credential type — oauth.md, otp.md; the whole credential system — credential.md, map.md, first-night-accounts.md; the whole application data layer — data-plan.md over ledger.md, with database-stack.md, jsonb.md, migration.md, and testing.md as their reference shelf, and data.md and smaller-dog.md as the work waiting beneath them, with data-cleanup.md holding the open items a finished sprint handed on; and outside all of it, digital-authentication.md, a survey of what everyone else does.
