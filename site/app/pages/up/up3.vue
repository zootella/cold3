...
async function run3(t) { bundle.summary3 = (await fetchWorker('/api/up', {body: {action: 'Up3Worker.'}})).summary; bundle.duration3 = Now()-t }
async function run4(t) { bundle.summary4 = (await fetchWorker('/api/up', {body: {action: 'Up3Lambda.'}})).summary; bundle.duration4 = Now()-t }
