...
//ttd december2025, okay, but couldn't there be a notification we know about during the server render, so it arrives with the page? maybe organizing stores around the universal render isn't the right pattern. also, maybe there should be a guard against running page-only code in the store itself, rather than just being careful where you call its methods in components
