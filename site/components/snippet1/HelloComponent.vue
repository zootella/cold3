...
<p>browser tag from local storage: <code>{{helloStore.browserTag}}</code></p>
<p>browser tag from private cookie: <code>{{helloStore.cookieTag}}</code></p>
<p>hello1 at {{helloStore.sticker1}} took {{helloStore.duration1}}ms</p>
